...
{
    public partial class busqueda_respuesta : Form
    {
        public busqueda_respuesta()
        {
            InitializeComponent();
        }
        ...
        private void busqueda_respuesta_Load(object sender, EventArgs e)
        {
            cargar_datos();
        }
        public void cargar_datos()
        {
            ...
            if (mantenimiento == false)
            {
                ...
                string sql = "select codigo,descripcion,estado from respuestas where estado='1'";
                if (descripcion_txt.Text.Trim() != "")
                {
                    sql += " and descripcion like '%" + descripcion_txt.Text.Trim() + "%'";
                }
